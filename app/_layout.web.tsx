...
// Abstraxion Provider through lib abstraction
import { AbstraxionProvider } from '@/lib/abstraxion';
...
const treasuryConfig = {
  ...
  callbackUrl: "http://localhost:8081", // this comes from app.json scheme
};
      ...
      <CustomThemeProvider>
        <ThemeProvider value={colorScheme === 'dark' ? DarkTheme : DefaultTheme}>
          <Stack>
            ...
            <Stack.Screen name="bubble/[id]" options={{ headerShown: false }} />
