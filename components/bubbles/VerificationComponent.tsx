...
import { BubbleMetadata, VerificationProvider } from '@/types/bubble';
...
export function VerificationComponent({ bubble, onVerificationComplete }: VerificationComponentProps) {
  ...
  // Don't show component if no verification providers are configured
        ...
        {availableProviders.map((provider) => (
          ...
          >
            <Text style={[
              ...
              selectedProvider?.id === provider.id && styles.selectedProviderButtonText
            ]}>
